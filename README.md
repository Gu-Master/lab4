...
![img_5.png](img_5.png)
График указывает, что данная последовательность обладает низкой автокорреляцией при ненулевых сдвигах, что делает её подходящей для использования в системах, где важны псевдослучайность и низкая корреляция, например, в телекоммуникациях и шифровании.
